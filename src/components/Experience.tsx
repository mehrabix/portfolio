  ...
  const experiences = [
    {
      ...
      achievements: [
        'Worked on and maintained micro-frontend architectures, improving scalability and system uptime.',
        ...
        'Improved backend performance using Spring Boot, NestJS, and PL/SQL.',
        'Streamlined backend processes and resolved integration challenges across major projects.',
        'Developed responsive user interfaces with React, Angular, and Next.js for better user experiences.',
        'Built automated deployment pipelines using GitLab CI, YAML, and Kubernetes for faster, reliable deployments.',
        'Collaborated closely with UI/UX teams to implement designs accurately.',
        'Enhanced backend reliability by developing robust RESTful APIs using Java, Spring Boot, and Node.js.',
      ],
    },
  ]
